        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" action="{{ route('requisitionslipsubmit') }}" name="requistionslipform" id="requistionslipform" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td class="ins">
                                                        @if ($superwiser == '1')
                                                            <a href="updaterequisitionslip/{{ $row->vno }}/{{ $row->vprefix }}/{{ $row->vtype }}">
                                                                <button class="btn btn-success editBtn update-btn btn-sm">
                                                                    <i class="fa-regular fa-pen-to-square"></i> {{ $row->veryfiuser != '' ? 'Verify' : 'Edit' }}
                                                                </button>
                                                            </a>
                                                        ...
                                                        <a href="requisitionslipdelete/{{ $row->docid }}"><button class="btn btn-danger btn-sm delete-btn">
