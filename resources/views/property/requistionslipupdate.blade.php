        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" action="{{ route('requisitionslipupdate') }}" name="requistionslipform" id="requistionslipform" method="POST" enctype="multipart/form-data">
                                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.items', function() {
                ...
                fetch("{{ url('itemstockval') }}", options)
            ...
            $('#requisitionslipupdate').on('submit', function(e) {
