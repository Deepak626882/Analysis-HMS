...
@section('main-container')
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" name="venuefeaturesform" action="{{url('venuefeaturesstore')}}" id="venuefeaturesform" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    @foreach ($data as $row)
                                        <tr>
                                            ...
                                            <td class="ins">
                                                ...
                                                <a href="{{ url('deletevenuefeatures/' . $row->sn . '/' . $row->code) }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{url('venuefeaturesupdateform')}}" name="venuefeaturesupdateform" id="venuefeaturesupdateform">
                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
           // handleFormSubmission('#venuefeaturesform', '#submitBtn', 'venuefeaturesstore');
            //handleFormSubmission('#venuefeaturesupdateform', '#updateBtn', 'venuefeaturesupdateform');
