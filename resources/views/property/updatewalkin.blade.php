                        ...
                        <div class="card-body walkin">
                            ...
                            <form class="walkin-form" id="walkinform" name="walkinform"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <input type="time" value="{{ $data[0]->chkintime }}" id="checkintime"
                                    ...
                                    <table class="table walkin-table table-responsive">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="booking_source" name="booking_source"
                                                        ...
                                                        @else
                                                            <option value="">Select</option>
                                                        @endif
                                                        <option value="Booking Engine" {{ $data[0]->booking_source == 'Booking Engine' ? 'selected' : '' }}>Booking Engine</option>
                                                        <option value="OTA" {{ $data[0]->booking_source == 'OTA' ? 'selected' : '' }}>OTA</option>
                                                        <option value="Travel Agent" {{ $data[0]->booking_source == 'Travel Agent' ? 'selected' : '' }}>Travel Agent</option>
                                                        <option value="Direct" {{ $data[0]->booking_source == 'Direct' ? 'selected' : '' }}>Direct</option>
                                                    </select>
                                                </td>
                                                <td>
                                                ...
                                                <td style="display: {{ $data[0]->booking_source == 'Travel Agent' ? 'block' : 'none' }};"
                                                    id="trveltd">
                                                    <select id="travel_agent" name="travel_agent" class="form-control low">
                                                        ...
                                                        @foreach ($travel_agent as $list)
                                                            <option value="{{ $list->sub_code }}" data-gst="{{ $list->gstin }}" {{ $data[0]->travelagent == $list->sub_code ? 'selected' : '' }}>{{ $list->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="position-absolute p-0">
                                    ...
                                    <table class="table-hover walkin-multi table-responsive" id="gridtaxstructure">
                                        ...
                                        <tbody>
                                            @foreach ($data as $dbrow)
                                                <tr class="data-row">
                                                    <td>
                                                        <select id="cat_code{{ $dbrow->sno1 }}" name="cat_code{{ $dbrow->sno1 }}"
                                                        ...
                                                        <input type="hidden" value="{{ $dbrow->planedit }}" class="form-control" name="planedit{{ $dbrow->sno1 }}" id="planedit{{ $dbrow->sno1 }}" readonly>
                                                    </td>
                                                    <td><select id="roommast{{ $dbrow->sno1 }}" name="roommast{{ $dbrow->sno1 }}" class="form-control sl"
                                                        required>
                                                    ...
                                                    <td><select id="adult{{ $dbrow->sno1 }}" name="adult{{ $dbrow->sno1 }}" class="form-control sl" required>
                                                        @if (empty($dbrow->adult))
                                                        <option value="" selected>Select</option>
                                                        @else
                                                        <option value="">Select</option>
                                                        @endif
                                                        <option value="1" {{ $dbrow->adult == '1' ? 'selected' : '' }}>1</option>
                                                        <option value="2" {{ $dbrow->adult == '2' ? 'selected' : '' }}>2</option>
                                                        <option value="3" {{ $dbrow->adult == '3' ? 'selected' : '' }}>3</option>
                                                        <option value="4" {{ $dbrow->adult == '4' ? 'selected' : '' }}>4</option>
                                                        <option value="5" {{ $dbrow->adult == '5' ? 'selected' : '' }}>5</option>
                                                    </select></td>
                                                    <td><select id="child{{ $dbrow->sno1 }}" name="child{{ $dbrow->sno1 }}" class="form-control sl" required>
                                                        @if (empty($dbrow->child))
                                                        <option value="0" selected>0</option>
                                                        @else
                                                        <option value="0" {{ $dbrow->child == '0' ? 'selected' : '' }}>0</option>
                                                        <option value="1" {{ $dbrow->child == '1' ? 'selected' : '' }}>1</option>
                                                        <option value="2" {{ $dbrow->child == '2' ? 'selected' : '' }}>2</option>
                                                        @endif
                                                    </select></td>
                                                    <td><select id="planmaster{{ $dbrow->sno1 }}" name="planmaster{{ $dbrow->sno1 }}" class="form-control planmastclass sl">
                                                            @if ($dbrow->plancode == '')
                                                                <option value="">Select</option>
                                                            @else
                                                                @foreach ($plans as $item)
                                                                    <option value="{{ $item->pcode }}" {{ $dbrow->plancode == $item->pcode ? 'selected' : '' }}>{{ $item->name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </td>
                                                    <td><input type="number" name="rate{{ $dbrow->sno1 }}" id="rate{{ $dbrow->sno1 }}"
                                                        oninput="checkNumMax(this, 10); handleDecimalInput(event);"
                                                        class="form-control ratechk sp" value="{{ $dbrow->rackrate }}" required></td>
                                                    <td><select class="form-control taxchk sl" name="tax_inc{{ $dbrow->sno1 }}" id="tax_inc{{ $dbrow->sno1 }}">
                                                            @if (empty($dbrow->rrtaxinc))
                                                                <option value="" selected>Select</option>
                                                            @else
                                                                <option value="">Select</option>
                                                            @endif
                                                            <option value="Y" {{ $dbrow->rrtaxinc == 'Y' ? 'selected' : '' }}>Yes</option>
                                                            <option value="N" {{ $dbrow->rrtaxinc == 'N' ? 'selected' : '' }}>No</option>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" {{ $dbrow->leaderyn == 'Y' ? 'checked' : '' }} class="leadercl" name="leader{{ $dbrow->sno1 }}" id="leader{{ $dbrow->sno1 }}">
                                                    </td>
                                                    <td>
                                                        @if ($dbrow->sno1 > 1)
                                                    ...
                                                    <td>
                                                        @if ($dbrow->planedit == 'Y')
                                                            <div class="">
                                                                <div style="display: none;" id="table-planmast{{ $dbrow->sno1 }}" class="table-responsive table-planmast">
                                                                    <h3 class="text-center adc">Plan Details</h3>
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <label id="plannamelabel" class="col-form-label" for="planname">Plan</label>
                                                                            <input type="text" value="{{ $dbrow->chargename }}" class="form-control" name="planname{{ $dbrow->sno1 }}" id="planname{{ $dbrow->sno1 }}" readonly>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <label id="plankaamountlabel" class="col-form-label" for="plankaamount">Plan Amount</label>
                                                                            <input autocomplete="off" type="text" value="{{ $dbrow->bnetplanamt }}" class="form-control planrow" name="plankaamount{{ $dbrow->sno1 }}" id="plankaamount{{ $dbrow->sno1 }}">
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <label id="taxincplanroomratelabel" class="col-form-label" for="taxincplanroomrate">Inc. In Room Rate</label>
                                                                            <input type="text" value="{{ $dbrow->btaxinc }}" class="form-control" name="taxincplanroomrate{{ $dbrow->sno1 }}" id="taxincplanroomrate{{ $dbrow->sno1 }}" readonly>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <label id="roomratelabel" class="col-form-label" for="roomrate">Room Rate</label>
                                                                            <input type="text" value="{{ $dbrow->broom_rate_before_tax }}" class="form-control" name="roomrate{{ $dbrow->sno1 }}" id="roomrate{{ $dbrow->sno1 }}" readonly>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                            <label id="netroomratelabel" class="col-form-label" for="netroomrate">Net Room Rate</label>
                                                                            <input type="text" value="{{ $dbrow->bnetplanamt - $dbrow->bamount }}" class="form-control" name="netroomrate{{ $dbrow->sno1 }}" id="netroomrate{{ $dbrow->sno1 }}" readonly>
                                                                            <input type="hidden" value="{{ $dbrow->btotal_rate }}" class="form-control" name="plansumrate{{ $dbrow->sno1 }}" id="plansumrate{{ $dbrow->sno1 }}">
                                                                            <input type="hidden" value="{{ $dbrow->btaxstru }}" class="form-control" name="taxstruplan{{ $dbrow->sno1 }}" id="taxstruplan{{ $dbrow->sno1 }}">
                                                                            <input type="hidden" value="{{ $dbrow->room_perplan }}" class="form-control" name="planpercent{{ $dbrow->sno1 }}" id="planpercent{{ $dbrow->sno1 }}">
                                                                            <input type="hidden" value="{{ $dbrow->pcode }}" class="form-control" name="plancodeplan{{ $dbrow->sno1 }}" id="plancodeplan{{ $dbrow->sno1 }}" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mt-3 d-flex justify-content-around">
                                                                        <table id="planmasttable{{ $dbrow->sno1 }}" class="table">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th>Sn</th>
                                                                                    <th>Fixed Charge</th>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><input autocomplete="off" type="text" value="{{ $dbrow->bamount }}" class="form-control rowdamount" name="rowdamount{{ $dbrow->sno1 }}" id="rowdamount{{ $dbrow->sno1 }}"></td>
                                                                                    <td>
                                                                                        <input type="text" value="{{ $dbrow->bplanper }}" class="form-control" name="rowdplan_per{{ $dbrow->sno1 }}" id="rowdplan_per{{ $dbrow->sno1 }}" readonly>
                                                                                        <input type="hidden" value="{{ $dbrow->bfixrate }}" class="form-control" name="rowdplanfixrate{{ $dbrow->sno1 }}" id="rowdplanfixrate{{ $dbrow->sno1 }}" readonly>
                                                                                        <input type="hidden" value="{{ $dbrow->brev_code }}" class="form-control" name="rowsrev_code{{ $dbrow->sno1 }}" id="rowsrev_code{{ $dbrow->sno1 }}" readonly>
                                                                                        <input type="hidden" value="{{ $dbrow->btaxstru }}" class="form-control" name="rowstax_stru{{ $dbrow->sno1 }}" id="rowstax_stru{{ $dbrow->sno1 }}" readonly>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="offset-10">
                                                                            <input type="text" value="{{ $dbrow->bnetplanamt }}" class="form-control" name="totalnetamtplan{{ $dbrow->sno1 }}" id="totalnetamtplan{{ $dbrow->sno1 }}" readonly>
                                                                        </div>
                                                                    </div>
                                                                    <div id="okbtnlabel{{ $dbrow->sno1 }}" class="text-center">
                                                                        <button id="okbtnplan{{ $dbrow->sno1 }}" name="okbtnplan{{ $dbrow->sno1 }}" type="button" class="btn okbtncls btn-success btn-sm"><i class="fa-regular fa-circle-check"></i> OK</button>
                                                                        <button id="closebtnplan{{ $dbrow->sno1 }}" name="closebtnplan{{ $dbrow->sno1 }}" type="button" class="btn closebtncls btn-danger btn-sm"><i class="fa-regular fa-circle-xmark"></i> Cancel</button>
                                                                    </div>
                                                                    <div id="resizeHandle{{ $dbrow->sno1 }}" class="resizeHandle"></div>
                                                                </div>
                                                            </div>
                                                        @endif
                                                    </td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div style="display: flex; align-items: normal;">
                                                <input type="text" name="name" value="{{ $data[0]->clientname }}"
                                                    placeholder="Full Name" maxlength="25" id="name" class="form-control"
                                                    required>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label for="profileimagepreview">
                                                                            <img style="height: 180px;width: 180px;" class="preview prevprofile" id="profileimagepreview"
                                                                                @if (empty($data[0]->pic_path)) src="admin/images/preview.gif" @else src="storage/walkin/profileimage/{{ $data[0]->pic_path }}" @endif
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label for="identityimagepreview">
                                                                                        <img style="height: 180px;width: 180px;" class="preview" id="identityimagepreview"
                                                                                            @if (empty($data[0]->idpic_path)) src="admin/images/preview.gif" @else src="storage/walkin/identityimage/{{ $data[0]->idpic_path }}" @endif
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input value="{{ $data[0]->rodisc }}" type="text" step="0.01" min="0.00" max="99.99" placeholder="0.00"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="tel"
                                                ...
                                                class="form-control" value="{{ $data[0]->mobile_no }}" {{ $enviro_formdata->grcmandatory == 'Y' ? 'required' : '' }}>
                                            <div style="display: none;" id="error-phone" class="error-phone text-danger">
                                                Invalid Number</div>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="col-form-label" for="email">Email</label>
                                            <input type="email" value="{{ $data[0]->email_id }}" name="email" placeholder="Email" maxlength="100" id="email"
                                                class="form-control">
                                        </div>
                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <select class="form-control" name="cityname" id="cityname" required>
                                                        <option value="" {{ empty($data[0]->city) ? 'selected' : '' }}>Select City</option>
                                                        @foreach ($citydata as $list)
                                ...
                                <div class="text-center mt-4 mb-4 ml-auto">
                                    <button type="button" class="btn ti-back-left btn-danger" onclick="window.location.href = '{{ url('checkinlist') }}'">Back </button>
                                    <button type="submit" name="walkinupdate" id="walkinupdate"
                                        class="btn btn-primary">Update Check In <i class="fa-solid fa-file-export"></i></button>
                                </div>
                            </form>
                        </div>
