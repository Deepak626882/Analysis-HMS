        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" name="itemcategoryform" action="{{url('itemcategorystore')}}" id="itemcategoryform" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" method="POST" action="{{url('itemcategoryupdatestr')}}" name="itemcategoryupform" id="itemcategoryupform">
                        @csrf
