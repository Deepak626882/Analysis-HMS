...
@section('main-container')
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" action="{{ route('stocktransfersubmit') }}" name="stocktransferform" id="stocktransferform" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td class="ins">
                                                        ...
                                                        @endif
                                                        <a href="deletestocktransfer/{{ $row->vno }}"><button class="btn btn-danger btn-sm delete-btn">
    ...
    <script>
        $(document).ready(function() {
            ...
            // function updatestockval(icode, departcode) {
