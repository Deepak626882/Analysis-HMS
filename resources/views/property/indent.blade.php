        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" action="{{ route('indentsubmit') }}" name="indentform" id="indentform" method="POST" enctype="multipart/form-data">
                                @csrf
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td class="ins">
                                                        ...
                                                        <a href="deleteindent/{{ $row->docid }}"><button class="btn btn-danger btn-sm delete-btn">
