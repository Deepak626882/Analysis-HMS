        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form" action="{{ route('stocktransferupdate') }}" name="stocktransferformupdate" id="stocktransferformupdate" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <input type="hidden" value="{{ $from->total }}" name="netamount" id="netamount">
                                <input type="hidden" value="{{ $data[0]->vno }}" name="vno" id="vno">
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{ $from->vdate }}" class="form-control" name="vdate" id="vdate" required>
                                            @error('vdate')
                                                <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="fromlocation" id="fromlocation" required>
                                                ...
                                                @foreach ($godown as $item)
                                                    <option value="{{ $item->scode }}" {{ $from->departcode == $item->scode ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('fromlocation')
                                                <span class="text-danger"> {{ $message }} </span>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tolocation" id="tolocation" required>
                                                <option value="">Select</option>
                                                @foreach ($godown as $item)
                                                    <option value="{{ $item->scode }}" {{ $to->departcode == $item->scode ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('tolocation')
                                                <span class="text-danger"> {{ $message }} </span>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $from->remarks }}" class="form-control" name="remarks" id="remarks">
                                            @error('remarks')
                                                <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="offset-10">
                                        <div class="text-right">
                                            ...
                                            <input type="text" value="{{ $fromrows->sum('amount') }}" class="form-control" name="totalamount" id="totalamount" readonly>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '.items', function() {
                ...
                const datap = {
                    'icode': value,
                    'departcode': $('#fromlocation').val().trim()
                };
                const options = {
                    method: 'POST',
                    headers: {
            ...
            $('#stocktransferformupdate').on('submit', function(e) {
