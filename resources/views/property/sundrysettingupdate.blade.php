        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card ">
                        <div class="card-body">
                            <form action="{{ route('updatesundry') }}" name="sundrysettingupform" id="sundrysettingupform"
                                method="post">
                                @csrf
                    ...
                    sundrysettingxhr.onreadystatechange = function() {
                        if (sundrysettingxhr.readyState === 4 && sundrysettingxhr.status === 200) {
                            ...
                            if (Array.isArray(results)) {
                                ...
                                <td style="max-width: 6rem !important;"><input readonly type="text" class="form-control automan" name="automan${adjustedIndex}" id="automan${index}" value="${item.automanual == 'A' ? 'Auto' : 'Manual'}"></td>`;
                                    row.append(data);
                                    tbody.append(row);
                                });
                            } else {
